...
public struct SawtoothNode : IAudioKernel<SawtoothNode.Parameters, SawtoothNode.Providers>
{
    ...
    public void Execute(ref ExecuteContext<Parameters, Providers> context) 
    {
        ...
        for (int s = 0; s < numSamples; s++)
        {
            ...
            float value = (gateValue == 1f) ? amplitude * (2f * (phase / (2f * math.PI)) - 1f) : 0f; // TEMPORARY!!!!!!
